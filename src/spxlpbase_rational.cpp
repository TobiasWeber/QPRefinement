...
/// Process RHS section.
static void MPSreadRhs(MPSInput& mps, LPRowSetBase<Rational>& rset, const NameSet& rnames, SPxOut* spxout, Rational *offset)
{
...
*/
static void MPSreadQuadObj(MPSInput& mps, QPMatrixBase<Rational>& qpset, NameSet& cnames, SPxOut* spxout)
{
   Rational val;
   int idx;
   int col_idx = 0;
   ...
   DIdxSet*      p_intvars)         ///< integer variables.
{
   ...
   QPMatrixBase<Rational>& qpset = *this;
   NameSet* rnames;
   NameSet* cnames;
   ...
   ) const
{
   ...
   {
      MPSwriteRecord(p_output, 0, "RHS", spxout, "MINIMIZE", offset);
   }
